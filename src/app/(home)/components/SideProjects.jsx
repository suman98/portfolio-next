...
const sideProjects = [
  {
    title: "Dharkaa",
    description:
      "Created a lightweight stock market portal integrated with TradingView, built using Laravel, React, and Material UI.",
  ...
  },
  {
    title: "best paani",
    description:
      "Created a web application for organizations to post and share their blogs, along with their company details and more.",
    ...
    >
      ...
      <Row gutter={[24, 24]} justify="center">
        {sideProjects.map((project, index) => (
          <Col key={project.title} xs={24} sm={24} md={12} lg={12} xl={12}>
            <Card
              hoverable
              style={{
                height: "100%",
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ marginBottom: "16px" }}>
                    ...
                    <Space align="center" style={{ marginBottom: "12px" }}>
                      <CalendarOutlined
                        style={{ color: isDarkMode ? "#8c8c8c" : "#595959" }}
                      />
                      <span
                        style={{
                          fontSize: "14px",
